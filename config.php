<?php
try {
    $bdd = new PDO("mysql:host=localhost;port=3308;dbname=reservation_system;charset=utf8", "root", ""); // Crée une nouvelle instance de PDO pour se connecter à la base de données
